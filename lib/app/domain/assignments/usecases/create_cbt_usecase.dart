...
class CreateCbtUseCase extends UseCase<AssignmentEntity, CreateCbtInput> {
  const CreateCbtUseCase(this._repository);

  final AssignmentsRepository _repository;

  @override
  ResultFuture<AssignmentEntity> call(CreateCbtInput params) {
    return _repository.createCbt(params);
  }
}
